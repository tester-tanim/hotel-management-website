   ...
   if(isset($_GET['fetch_rooms']))
   {
      ...
      if($chk_avail['checkin'] != '' && $chk_avail['checkout'] != '')
      {
        ...
        if ($checkin_date == $checkout_date) {
            echo "<h3 class='text-center text-danger'>Invalid Date Entered!</h3>";
            exit;
      ...
      // fetch settings table to check website is shutdown or not
      ...
      while($room_data = mysqli_fetch_assoc($room_res))
      {
            ...
            while ($fac_row = mysqli_fetch_assoc($fac_q)) {
                ...
                $facilities_data .= "<span class='badge rounded-pill bg-light text-dark text-warp me-1 mb-1'>$fac_row[name]</span>";
            }
            ...
            {
            $features_data .= "<span class='badge rounded-pill bg-light text-dark text-warp me-1 mb-1'>$fea_row[name]</span>";
            }
                    ...
                    <div class='card mb-4 border-0 shadow'>
                        <div class='row g-0 p-3 align-item-center'> 
                            ...
                            <div class='col-md-5 ps-4'>
                                ...
                                <div class='facilities mt-1'>
                                    <h6 class='mb-1'>Facilites</h6>
                                    $facilities_data
                                </div>
                                <div class='guest mt-1'>
                                    <h6 class='mb-1'>Guest</h6>
                                    <span class='badge rounded-pill bg-light text-dark text-warp'>$room_data[adult] Adults</span> 
                                    <span class='badge rounded-pill bg-light text-dark text-warp'>$room_data[children] Children</span>
                                </div>
                            </div>
