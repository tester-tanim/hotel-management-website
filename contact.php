...
<body class="bg-light">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 mb-5 px-4">  <!--Left Side-->
            ...
            <div class="col-lg-6 col-md-6 px-4">
                <div class="bg-white rounded shadow p-4 ">  <!--Right Side-->
                    <form method="POST">
                        <h5>Send Message</h5>
                        <div class="mt-3">   
                        ...
                        <button type="submit" name="send" class="btn text-white bg-info mt-3 ">SEND</button>
                    </form>
                </div>
            </div>
        </div>
