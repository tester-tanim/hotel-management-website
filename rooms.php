...
<head>
    ...
    <?php require('inc/links.php'); ?>      <!--include link.php -->
...
<div class="my-5 px-4">
    <h2 class="fw-bold k-font text-center">OUR ROOMS</h2>
    <div class="h-line bg-dark"></div>
</div>
<div class="container-fluid">
    <div class="row">

        <div class="col-lg-3 col-md-12 mb-lg-0 mb-4 ps-4">          <!-- Left side Navbar code for filter -->
            <nav class="navbar navbar-expand-lg navbar-light bg-white rounded shadow">
                <div class="container-fluid flex-lg-column align-items-stretch">
                  ...
                  <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
                    ...
                    <!-- <div class="border bg-light p-3 rounded mb-3">    Room Type -->
                        <!-- <h5 class="mb-3" style="font-size: 18px;">ROOM TYPE</h5>
                        <div class="mb-2">
                            <input type="checkbox" id="f1" class="form-check-input shadow-none me-1">
                            <label class="form-check-label" for="f1">Deluxe</label>
                        </div>
                        <div class="mb-2">
                            <input type="checkbox" id="f2" class="form-check-input shadow-none me-1">
                            <label class="form-check-label" for="f2">Super Deluxe</label>
                        </div>
                        <div class="mb-2">
                            <input type="checkbox" id="f3" class="form-check-input shadow-none me-1">
                            <label class="form-check-label" for="f3">Luxury</label>
                        </div>
                    </div> -->
                  </div>
                </div>
        ...
        <div class="col-lg-9 col-md-12 px-4" id="rooms-data">        <!-- Rignt side search result-->
