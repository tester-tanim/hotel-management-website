...
<div class="container-fluid bg-dark py-4 mt-5 text-white">
    <div class="row justify-content-center">
        <div class="col-lg-3 p-4">
            <h3 class="R-font fw-bold fs-3 mb-2 "><?php echo $settings_r['site_title'] ?></h3>
            <p>
...
<!-- Credit -->
        <h6 class="text-center bg-white text-dark p-3 m-0">
             Copyright <i class="bi bi-c-circle"></i> 2023 Team SUB. All Right Resurved</h6>


<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>    <!--connect bootstep5 for JS-->   
